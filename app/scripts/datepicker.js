angular.module('customDatePicker', [])

.directive('ngTimepicker', ['$document', function($document) {

  var setScopeValues = function(scope, attrs) {

    scope.initTime = attrs.initTime || "00:00";
    scope.step = attrs.step || '01';
  ...
  return {
    ...
    template: '<input type="text" ng-focus="showTimepicker()" ng-value="viewValue" class="ng-timepicker-input form-control" ng-readonly="true">' +
      '<div class="ng-timepicker timepick" ng-show="opened" ng-class="{\'red\': theme === \'red\', \'green\': theme === \'green\', \'blue\': theme === \'blue\'}">' +
      '  <table>' +
      '    <tbody>' +
      '    <tr>' +
      ...
      '      </tr>' +
      '      <tr>' +
      '        <td><input type="text" class="form-control" ng-model="hour" ng-readonly="true"></td>' +
      '        <td>:</td>' +
      '        <td><input type="text" class="form-control" ng-model="minutes" ng-readonly="true"></td>' +
